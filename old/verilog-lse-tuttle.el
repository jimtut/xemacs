...
;; and modify its variables later in this file.
	  ...
	  ;; else (cds-inst-dir is nil because the CDS_INST_DIR
...
(define-key cvlog-c-mode-map 'f8 'cvlog-run-analyzer) ;; save & analyze
